...
func main() {
    ...
    part_val := "export bucket=cnn-s3-rg-edw && export http_proxy=http://infa:Ian\\ McKellen@10.155.97.30:3872 && export https_proxy=http://infa:Ian\\ McKellen@10.155.97.30:3872"
